# Build log: GitHub Actions → AWS OIDC, validated with `tf-policy-validator`

This is the raw build/debugging journal from developing this project — chronological, including
every failed attempt, iteration count, and real command output as it happened. For the actual
